...
import { getMyAge, goToUrl, loadMore } from '../utils/functions';
                    ...
                    <Grid alignItems="center" container>
                        ...
                        <Grid xs={6} direction="column" item container>
                            ...
                            <Typography align="justify" sx={styles.textAbout}>
                                Sou o Janilso Rodrigues, tenho {getMyAge()}{' '}
                                anos. Sou desenvolvedor{' '}
                                <mark>web frontend pleno</mark>, que gosta de se
                                aventurar no mobile, e um pouco no bakend. Sou
                                um Maranhense que iniciou o Curso de{' '}
                                <mark>Sistemas de Informação</mark>, conseguiu
                                uma oportunidade de emprego em São Paulo e
                                decidiu arriscar. Me mudei, transferi o curso
                                para SP e estou nos últimos semestres! Gosto
                                muito de estar atento às{' '}
                    ...
                    >
                        ...
                        <Grid item sx={styles.more}>
                            <CustomButton
                                onClick={() =>
                                    setRange(
                                        range < projects?.length ? newRange : 3,
                                    )
                                }
                                variant="outlined"
                            >
                    ...
                    <Grid justifyContent="space-between" container>
                        <Grid xs={4} direction="column" item container>
                            ...
                            <Typography sx={styles.textAbout}>
                                Ao lado estou exibindo algumas habilidades que
                                tenho.
                            </Typography>
                        </Grid>
